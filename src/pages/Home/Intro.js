...
function Intro() {
  return (
    <div className='h-[100vh] bg-primary flex flex-col items-start justify-center gap-8 py-10'>
      ...
      <button onClick={() => window.open("https://drive.google.com/file/d/1wc9wOCEgy4RTpj_swPEwbjZixJ33P3Um/view?usp=sharing")} className='border-2 border-tertiary text-tertiary px-10 py-3 rounded'>
        View Resume
      </button>
    </div>
  )
